...
fun main() {
 ...
 val messaage = buildString {
     ...
     * karena receiver objek yg mengakses ekstension function berupa lamda
     ...
     yaitu ekstention functionnya berupa lamda
     oleh karena itu di blok lamda itu kita bisa mengakses context objek dari
     class StringBuilder karena objek sat ini merupakan class string builder
     */
